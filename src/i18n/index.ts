...
export interface Translations {
  ...
  aiCompacting: string;
  aiWorkingElapsed: (elapsed: string, tool: string) => string;
  aiWorkingStalled: string;
  aiSendingOtherThread: string;
  aiActivitySummary: (searches: number, commands: number) => string;
  aiActivityDetails: string;
  aiChangeEdited: string;
  aiChangeKeep: string;
  aiChangeUndo: string;
  aiChangeKept: string;
  ...
  aiCustomInstructionsHint: string;
  aiProjectInstructions: string;
  aiWorkspaceWrite: string;
  aiWorkspaceWriteHint: string;
  aiModeAsk: string;
  aiModeAgent: string;
  aiModePlan: string;
  ...
  reportFeedbackTitle: string;
  reportFeedbackSubject: string;
  reportFeedbackWhatHappened: string;
  reportFeedbackIncludeDiag: string;
  reportFeedbackCopy: string;
  reportFeedbackOpenIssue: string;
  reportFeedbackEmail: string;
  reportFeedbackScreenshots: string;
  reportFeedbackAddScreenshot: string;
  reportFeedbackPasteHint: string;
  reportFeedbackRemoveScreenshot: string;
  reportFeedbackPrivacy: string;
  reportFeedbackCopied: string;
  reportFeedbackCopiedEmail: string;
  reportFeedbackCopiedWithShots: string;
  shortcutsTab: string;
  shortcutsReset: string;
  shortcutsPressKey: string;
  shortcutsConflict: string;
  shortcutsUnbound: string;
  shortcutsCaptureHint: string;
